    ...
    <>
            <div className='menu-alpha'>
                <div className="menu-home">
                    <div className="menu-container"><div className="menu-div" href="/">EXPLORE</div></div>
                </div>
                <div className="menu">
                    ...
                    <div className="menu-container">
                        <ul className="options">
                            ...
                            <li className="nav"><a href="/" className="nav-link">Merch <span className="small-number">04</span></a></li>
